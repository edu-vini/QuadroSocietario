 ...
 */
final class Version20240322222657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE empresa (id INT NOT NULL, cnpj VARCHAR(14) NOT NULL, razao_social VARCHAR(255) NOT NULL, fantasia VARCHAR(255) NOT NULL, endereco VARCHAR(255) NOT NULL, telefone VARCHAR(11) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE socio (id INT NOT NULL, cpf VARCHAR(11) NOT NULL, nome VARCHAR(255) NOT NULL, endereco VARCHAR(255) NOT NULL, telefone VARCHAR(11) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE usuario (id INT NOT NULL, nome_usuario VARCHAR(20) NOT NULL, roles JSON NOT NULL, senha VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2265B05D7878DEE5 ON usuario (nome_usuario)');
